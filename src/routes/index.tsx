      ...
      <footer className="border-t border-line">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-center gap-4 px-5 py-8 text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-5 text-sm text-ink-muted">
            ...
            <a 
              href="https://wa.me/213776338127" 
              target="_blank" 
              rel="noreferrer" 
              className="inline-flex items-center gap-1.5 rounded-full bg-wa-ink/10 px-3 py-1 text-wa-ink transition-colors hover:bg-wa-ink/20"
            >
